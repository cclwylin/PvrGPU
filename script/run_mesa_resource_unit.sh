...
# Usage: bash script/run_mesa_resource_unit.sh [all|blit|clear]
set -euo pipefail
...
abort 'usage: run_mesa_resource_unit.sh [all|blit|clear]' unless
  %w[all blit clear].include?(selected)
