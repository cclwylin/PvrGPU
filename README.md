...
- [docs/DRAWLIST_SNAPSHOT_REPLAY.md](docs/DRAWLIST_SNAPSHOT_REPLAY.md): whole-state DrawList checkpoints, fresh-process suffix replay, compatibility rules and equivalence validation.
