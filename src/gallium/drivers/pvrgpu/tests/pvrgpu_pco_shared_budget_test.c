...
int main(int argc, char **argv)
{
   ...
   for (unsigned i = 0; i < CASE_COUNT; ++i) {
      ...
      case 2: current = "static92-live-ubo"; v.base = 22; v.load_ubo = true;
         expected_ubos = 1; expected_count = 92; expected_start = 4; rescued = true; break;
      case 3: current = "indirect92-live-ubo"; v.base = 20; v.range = 3; v.indirect = true; v.load_ubo = true;
         expected_ubos = 1; expected_count = 92; expected_start = 4; rescued = true; break;
      case 4: current = "indirect96-live-ubo-packed"; v.base = 20; v.range = 4; v.indirect = true; v.load_ubo = true; packed = true;
         expected_ubos = 1; expected_count = 16; expected_start = 4; rescued = true; break;
      case 5: current = "high-binding-prefix-retained"; v.base = 21; v.ubos = 3; v.block = 1; v.load_ubo = true;
         expected_ubos = 2; expected_count = 88; expected_start = 8; rescued = true; break;
      ...
      case 8: current = "already-fitting-dead-ubo-unchanged"; v.bound = 92; v.base = 0;
         expected_ubos = 1; expected_count = 92; expected_start = 4; break;
      case 9: current = "already-fitting-live-ubo-unchanged"; v.bound = 92; v.base = 0; v.load_ubo = true;
         expected_ubos = 1; expected_count = 92; expected_start = 4; break;
      ...
      case 11: current = "bound-oob-refused"; v.bound = 95; success = false; break;
      ...
      case 20: current = "fragment252-live-ubo"; f = full; f.bound = 256; f.base = 62; f.load_ubo = true; v = empty;
         fragment = true; expected_ubos = 1; expected_count = 252; expected_start = 4; rescued = true; break;
      case 21: current = "fragment256-live-ubo-packed"; f = full; f.bound = 256; f.base = 63; f.load_ubo = true; v = empty;
         fragment = true; packed = true; expected_ubos = 1; expected_count = 4; expected_start = 4; rescued = true; break;
      case 22: current = "fragment256-dead-ubo"; f = full; f.bound = 256; f.base = 63; v = empty;
         fragment = true; expected_count = 256; rescued = true; break;
      case 23: current = "static-nonzero-offset"; v.base = 20; v.offset = 2; v.load_ubo = true;
         expected_ubos = 1; expected_count = 92; expected_start = 4; rescued = true; break;
      case 24: current = "scalar-last-word-prefix"; v.base = 22; v.components = 1; v.load_ubo = true;
         expected_ubos = 1; expected_count = 89; expected_start = 4; rescued = true; break;
      ...
      case 28: current = "size-query-preserves-binding-prefix"; v.base = 21; v.ubos = 3; v.block = 1; v.size_ubo = true;
         expected_ubos = 2; expected_count = 88; expected_start = 8; rescued = true; break;
      case 29: current = "fragment-image-pins-ubo-packed"; f = full; f.bound = 256; f.base = 61; f.image = true; v = empty;
         fragment = true; packed = true; expected_ubos = 1; expected_count = 4; expected_start = 12; rescued = true; break;
      case 30: current = "fragment-image-cb0-only-shrink"; f = full; f.bound = 256; f.base = 60; f.image = true; v = empty;
