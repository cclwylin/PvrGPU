...
class PvrGpuGalliumDriverTreeTests(unittest.TestCase):
    ...
    def test_phase1_skeleton_files_exist(self) -> None:
        expected = {
            ...
            "pvrgpu_cmd.c",
            "pvrgpu_cmd.h",
            "pvrgpu_color_formats.h",
            "pvrgpu_compute_snapshot.h",
            "pvrgpu_context.c",
            "pvrgpu_context.h",
            "pvrgpu_counter.c",
            "pvrgpu_counter.h",
            ...
            "pvrgpu_pco.c",
            "pvrgpu_pco.h",
            "pvrgpu_push_constants.h",
            "pvrgpu_payload_budget.h",
            ...
            "pvrgpu_systemc_limits.h",
            "pvrgpu_systemc_compute_api.h",
            "pvrgpu_uniform_buffer.h",
            "pvrgpu_tessellation.h",
        }
        self.assertEqual(
            expected,
    ...
    def test_effect2d_textured_triangle_lowering_is_strict(self) -> None:
        ...
        self.assertIn("PVRGPU_SYSTEMC_API_VERSION 32u", systemc_api)
        for field in (
    ...
    def test_skeleton_targets_mesa_software_loader_api(self) -> None:
        ...
        self.assertIn("ctx->framebuffer.cbufs[0].texture", clear)
        self.assertIn("ctx->framebuffer.cbufs[target]", clear)
