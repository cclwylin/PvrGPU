...
class PvrGpuGalliumDriverTreeTests(unittest.TestCase):
    ...
    def test_public_pco_lowering_is_wired_and_fail_closed(self) -> None:
        ...
        self.assertIn("0xe5ede07e1317d604", native_test)
        self.assertIn("0xf37c4b6785de2e44", native_test)
        self.assertIn("0x834f6b41c2c7bdd8", native_test)
        self.assertIn("0xde47363e398a2bcc", native_test)
        self.assertIn("0x02a543327636e98f", native_test)
        self.assertIn("0x6b171a8aaec8fa96", native_test)
        self.assertIn("0xa6e167a6cd068362", native_test)
        self.assertIn("0x1fd6e9c5b3efd7bd", native_test)
        self.assertIn("0x0196ab8e374c830d", native_test)
