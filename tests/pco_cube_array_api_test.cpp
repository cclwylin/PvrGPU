...
int main(){try{
  static_assert(PVRGPU_SYSTEMC_API_VERSION==42&&PVRGPU_SYSTEMC_MAX_PCO_TEXTURES_PER_STAGE==16);
  static_assert(sizeof(void*)!=8||sizeof(pvrgpu_systemc_pco_sequence_texture)==368,"API32 retains texture struct size");
