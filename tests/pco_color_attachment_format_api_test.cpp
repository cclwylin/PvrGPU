...
#if !defined(_WIN32)
  static_assert(PVRGPU_SYSTEMC_API_VERSION==40);
...
int main() {
  try {
    ...
    {Fixture f;f.draws[0].color_attachment_formats[1]="PIPE_FORMAT_R9G9B9E5_FLOAT";Reject(root,f,"unsupported","color attachment formats");}
